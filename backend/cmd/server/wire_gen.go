...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	// 注册后发放试用密钥；用 setter 而非构造参数，避免双向依赖。
	authService.SetSignupTrialKeyIssuer(apiKeyService)
