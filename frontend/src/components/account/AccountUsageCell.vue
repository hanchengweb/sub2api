        ...
        <div v-if="grokLocalUsage" class="mb-0.5 flex items-center">
          <div class="flex items-center gap-1.5 text-[9px] text-gray-500 dark:text-gray-400">
            ...
            <span class="rounded bg-gray-100 px-1.5 py-0.5 dark:bg-gray-800" :title="t('usage.accountBilled')">
              A {{ formatWindowCost(grokLocalUsage) }} {{ t('common.creditUnit') }}
            </span>
            <span
            ...
            >
              U {{ formatWindowUserCost(grokLocalUsage) }} {{ t('common.creditUnit') }}
            </span>
          </div>
        </div>
        <UsageProgressBar
      ...
      <div class="space-y-1">
        ...
        >
          <div class="flex items-center gap-1.5 text-[9px] text-gray-500 dark:text-gray-400">
            ...
            <span class="rounded bg-gray-100 px-1.5 py-0.5 dark:bg-gray-800" :title="t('usage.accountBilled')">
              A {{ formatKeyCost }} {{ t('common.creditUnit') }}
            </span>
            <span
              ...
              :title="t('usage.userBilled')"
            >
              U {{ formatKeyUserCost }} {{ t('common.creditUnit') }}
            </span>
          </div>
        </div>
        <div
