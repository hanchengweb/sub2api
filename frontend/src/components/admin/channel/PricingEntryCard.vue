      ...
      <div class="collapsible-inner">
        ...
        <div v-if="entry.billing_mode === 'token'">
          ...
          <label class="mt-3 block text-xs font-medium text-gray-500 dark:text-gray-400">
            ...
            <span class="ml-1 font-normal text-gray-400">{{ t('common.creditUnit') }}/MTok</span>
          </label>
        ...
        <div v-else-if="entry.billing_mode === 'per_request'">
          ...
          <label class="mt-3 block text-xs font-medium text-gray-500 dark:text-gray-400">
            ...
            <span class="ml-1 font-normal text-gray-400">{{ t('common.creditUnit') }}</span>
            <span v-if="yuanHint(entry.per_request_price)" class="ml-1 font-normal text-gray-400">{{ yuanHint(entry.per_request_price) }}</span>
          </label>
          <div class="mt-1 w-48">
...
import { perTokenToMTok, getPlatformTagClass, yuanHint } from './types'
