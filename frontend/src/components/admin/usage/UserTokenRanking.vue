      ...
      <table class="w-full min-w-max divide-y divide-gray-200 dark:divide-dark-700">
        ...
        <tbody class="divide-y divide-gray-200 bg-white dark:divide-dark-700 dark:bg-dark-900">
          ...
          >
            ...
            <td class="whitespace-nowrap px-4 py-3 text-right text-sm font-medium tabular-nums text-green-600 dark:text-green-400">{{ fmtCost(item.actual_cost) }} {{ t('common.creditUnit') }}</td>
          </tr>
        </tbody>
      </table>
    </div>
