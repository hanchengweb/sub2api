<template>
  <div class="group/usage relative text-sm">
    <div class="flex items-center gap-1.5">
      ...
      <span class="font-medium text-gray-900 dark:text-white">{{ today.toFixed(4) }} {{ t('common.creditUnit') }}</span>
      <Icon
        v-if="hasBreakdown"
        name="infoCircle"
        size="xs"
    ...
    <div class="mt-0.5 flex items-center gap-1.5">
      ...
      <span class="font-medium text-gray-900 dark:text-white">{{ total.toFixed(4) }} {{ t('common.creditUnit') }}</span>
    </div>
    ...
    >
      ...
      >
        ...
        <span class="font-mono">
          {{ item.today_actual_cost.toFixed(4) }} {{ t('common.creditUnit') }}
          <span class="opacity-50">/</span>
          {{ item.total_actual_cost.toFixed(4) }} {{ t('common.creditUnit') }}
        </span>
      </div>
    </div>
  </div>
