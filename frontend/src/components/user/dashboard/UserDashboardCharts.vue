            ...
            <table class="w-full text-xs">
              ...
              <tbody>
                <tr v-for="model in models" :key="model.model" class="border-t border-gray-100 dark:border-dark-700">
                  ...
                  <td class="py-1.5 text-right text-green-600 dark:text-green-400">{{ formatCost(model.actual_cost) }} {{ t('common.creditUnit') }}</td>
                  <td class="py-1.5 text-right text-gray-400 dark:text-gray-500">{{ formatCost(model.cost) }} {{ t('common.creditUnit') }}</td>
                </tr>
              </tbody>
            </table>
          </div>
