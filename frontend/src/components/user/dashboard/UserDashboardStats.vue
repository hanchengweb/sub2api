    ...
    <div v-if="!isSimple" class="card p-4">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-xl font-bold text-emerald-600 dark:text-emerald-400">{{ formatBalance(balance) }} {{ t('common.creditUnit') }}</p>
      ...
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-xl font-bold text-gray-900 dark:text-white">
            <span class="text-purple-600 dark:text-purple-400" :title="t('dashboard.actual')">{{ formatCost(stats?.today_actual_cost || 0) }} {{ t('common.creditUnit') }}</span>
            <span class="text-sm font-normal text-gray-400 dark:text-gray-500" :title="t('dashboard.standard')"> / {{ formatCost(stats?.today_cost || 0) }} {{ t('common.creditUnit') }}</span>
          </p>
          <p class="text-xs">
            <span class="text-gray-500 dark:text-gray-400">{{ t('common.total') }}: </span>
            <span class="text-purple-600 dark:text-purple-400" :title="t('dashboard.actual')">{{ formatCost(stats?.total_actual_cost || 0) }} {{ t('common.creditUnit') }}</span>
            <span class="text-gray-400 dark:text-gray-500" :title="t('dashboard.standard')"> / {{ formatCost(stats?.total_cost || 0) }} {{ t('common.creditUnit') }}</span>
          </p>
        </div>
      </div>
    </div>
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <span class="font-mono text-sm text-purple-600 dark:text-purple-400" :title="t('dashboard.actual')">
            {{ formatCost(item.total_actual_cost) }} {{ t('common.creditUnit') }}
          </span>
        </div>
        <div class="mt-2 space-y-1 text-xs">
          <div class="flex items-center justify-between">
            <span class="text-gray-500 dark:text-gray-400">{{ t('dashboard.todayCost') }}</span>
            <span class="font-mono text-gray-900 dark:text-white">{{ formatCost(item.today_actual_cost) }} {{ t('common.creditUnit') }}</span>
          </div>
          <div class="flex items-center justify-between">
