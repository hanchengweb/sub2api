      ...
      <template v-if="notifyEnabled">
        ...
        <div>
          ...
          <div class="flex items-center gap-2">
            <span class="text-sm text-gray-500">{{ t('common.creditUnit') }}</span>
            <input
              ...
              step="0.01"
              class="input flex-1"
              :placeholder="systemDefaultThreshold > 0 ? `${t('profile.balanceNotify.systemDefault')} ${systemDefaultThreshold} ${t('common.creditUnit')}` : t('profile.balanceNotify.thresholdPlaceholder')"
            />
            <button
