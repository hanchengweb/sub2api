export default {
    ...
    agentPricing: {
      ...
      plansHint: 'A plan is only a rule — editing it does not recompute prices already generated. Preview and apply again.',
      newPlan: 'New plan',
      editPlan: 'Edit plan',
      planName: 'Plan name',
      textDiscount: 'Text discount',
      textDiscountHint: 'Agent price = retail × this value. 0.8 leaves the agent a 20% margin.',
      // "80% of retail", not "80% off" — 0.8 means the agent pays 80%, saving 20%.
      discountValue: '{n}0% of retail',
      deductionCny: 'Multimodal per-call cut',
      deductionCnyHint: 'Agent price = retail − this amount. Entered in CNY, converted using the credit rate.',
      perCall: 'call',
      costFloor: 'Cost floor guard',
      generatorTitle: 'Generate wholesale prices',
      generatorHint: 'Reads retail prices from the source channel, applies the plan, writes to the target channel on confirm',
      plan: 'Pricing plan',
      sourceChannel: 'Source channel',
      sourceHint: 'Retail prices are read from here and left untouched',
      targetChannel: 'Target channel',
      targetHint: 'The agent-only channel prices are written to',
      targetEqualsSource: 'Target cannot equal source — that would overwrite retail prices with agent prices',
      preview: 'Preview',
      apply: 'Apply to target channel',
      applied: 'Wrote {n} pricing rows to "{channel}"',
      previewTitle: 'Preview · {plan}',
      creditRate: 'Credit rate',
      creditsPerYuan: 'credits per CNY',
      deduction: 'Per-call cut in credits',
      rowSummary: '{total} rows, {skipped} kept at retail, {warned} with warnings',
      model: 'Model',
      retailPrice: 'Retail (credits)',
      agentPrice: 'Agent (credits)',
      margin: 'Agent margin',
      warning: 'Warning',
      confirmTitle: 'Confirm writing agent prices',
      confirmBody: 'This writes {n} pricing rows to "{channel}" and immediately changes what agents pay.',
      confirmWarnings: '{n} of them carry warnings — review the preview before continuing.',
      confirmApply: 'Write prices',
      loadPlansFailed: 'Failed to load pricing plans',
      loadChannelsFailed: 'Failed to load channels',
      previewFailed: 'Preview failed, please try again',
      applyFailed: 'Write failed, please try again',
