export default {
  agency: {
    ...
    tooManyPending: 'You already have an application in progress',
    submitted: 'Submitted. We are on it — no need to send it again; we will reach you at the email you gave.',
    pending: 'You already have an application in progress — no need to send it again.',
    ...
    email: 'Contact email',
    emailPlaceholder: 'Email for partnership discussions',
    company: 'Company or team',
    companyPlaceholder: 'Company or team name',
    optional: '(optional)',
    scenario: 'Use case',
    generate: 'Prepare partnership brief',
    contact: 'Contact us',
    brief: 'Partnership brief',
    briefHint: 'Copy this brief and send it to the platform contact to start a conversation.',
    noContact: 'Contact details are not published yet. Please use your existing support channel.',
    copyBrief: 'Copy brief',
    copyContact: 'Copy contact details',
    backToEdit: 'Back to editing',
    copied: 'Copied',
    copyFailed: 'Could not copy. Select the text and copy it manually.',
    required: 'Please fill out this field.',
    directions: {
      channel: { title: 'Channel promotion', description: 'Connect customer needs with AI products and services.', placeholder: 'Your audience, promotion channels and partnership plans' },
  ...
  modelPlaza: {
    ...
    table: {
      ...
      unitPerMillionPaid: 'credits / 10K tokens',
      unitPerMillion: '$ / 1M tokens',
