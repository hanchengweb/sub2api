export default {
  playground: {
    ...
    refImageAdd: 'Add reference image',
    refImageUploading: 'Uploading…',
    refImageRemove: 'Remove reference image',
    refImageAlt: 'Reference image',
    refImageBadType: 'Only PNG / JPEG / WebP / GIF are supported',
    refImageTooLarge: 'Image must be 10MB or smaller',
    refImageFailed: 'Reference image upload failed',
    paramAspect: 'Ratio',
