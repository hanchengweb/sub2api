export default {
    ...
    agentPricing: {
      ...
      plansTitle: '定价方案',
      plansHint: '方案只是规则，改了不会自动重算已生成的价格——要重新预览并应用一次',
      newPlan: '新建方案',
      editPlan: '编辑方案',
      planName: '方案名称',
      textDiscount: '文本折扣',
      textDiscountHint: '代理价 = 零售价 × 本值。0.8 表示八折，代理有 20% 利润空间',
      discountValue: '{n} 折',
      deductionCny: '多模态每次让利',
      deductionCnyHint: '代理价 = 零售价 − 本金额。按人民币填，系统按积分汇率折算',
      perCall: '次',
      costFloor: '成本下限保护',
      generatorTitle: '生成批发价',
      generatorHint: '从来源渠道读零售价，按方案算出代理价，确认后写入目标渠道',
      plan: '定价方案',
      sourceChannel: '来源渠道',
      sourceHint: '零售价从这里读，不会被改动',
      targetChannel: '目标渠道',
      targetHint: '代理专属渠道，价格写到这里',
      targetEqualsSource: '目标渠道不能与来源渠道相同：那会把零售价直接改成代理价',
      preview: '预览',
      apply: '应用到目标渠道',
      applied: '已写入 {n} 条定价到「{channel}」',
      previewTitle: '预览 · {plan}',
      creditRate: '积分汇率',
      creditsPerYuan: '积分/元',
      deduction: '每次让利折算',
      rowSummary: '共 {total} 条，{skipped} 条退回零售价，{warned} 条有告警',
      model: '模型',
      retailPrice: '零售价（积分）',
      agentPrice: '代理价（积分）',
      margin: '代理利润率',
      warning: '告警',
      confirmTitle: '确认写入代理价',
      confirmBody: '将向「{channel}」写入 {n} 条定价，这会立即改变代理的实际成交价。',
      confirmWarnings: '其中 {n} 条带告警，请先在预览里看过再继续。',
      confirmApply: '确认写入',
      loadPlansFailed: '加载定价方案失败',
      loadChannelsFailed: '加载渠道列表失败',
      previewFailed: '预览失败，请稍后重试',
      applyFailed: '写入失败，请稍后重试',
      savePlanFailed: '保存方案失败，请稍后重试'
    },
    scheduledTests: {
      title: '定时测试',
      addPlan: '添加计划',
