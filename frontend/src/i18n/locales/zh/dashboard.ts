export default {
  agency: {
    ...
    tooManyPending: '你已有申请正在处理中，请等待平台联系',
    submitted: '提交成功，处理中，请勿重复提交。我们会通过你填写的邮箱与你联系。',
    pending: '你已有申请正在处理中，请勿重复提交。',
    ...
    contact: '联系平台',
    brief: '合作说明',
    briefHint: '复制后发送给平台联系人，即可发起合作沟通。',
    noContact: '平台暂未公开联系方式，请通过你已有的客服渠道咨询。',
    copyBrief: '复制合作说明',
    copyContact: '复制联系方式',
    backToEdit: '返回修改',
    copied: '已复制',
    copyFailed: '复制未成功，请选中文本手动复制。',
    required: '请填写此项。',
    directions: {
      channel: { title: '渠道推广', description: '连接客户需求，推广 AI 产品与服务。', placeholder: '你的客户群体、推广渠道与合作计划' },
