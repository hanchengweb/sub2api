            ...
            <div class="min-w-[280px] space-y-2">
              ...
              <div v-if="row.group?.daily_limit_usd" class="usage-row">
                <div class="flex items-center gap-2">
                  ...
                  <span class="usage-amount">
                    {{ row.daily_usage_usd?.toFixed(2) || '0.00' }} {{ t('common.creditUnit') }}
                    <span class="text-gray-400">/</span>
                    {{ row.group?.daily_limit_usd?.toFixed(2) }} {{ t('common.creditUnit') }}
                  </span>
                </div>
              ...
              <div v-if="row.group?.weekly_limit_usd" class="usage-row">
                <div class="flex items-center gap-2">
                  ...
                  <span class="usage-amount">
                    {{ row.weekly_usage_usd?.toFixed(2) || '0.00' }} {{ t('common.creditUnit') }}
                    <span class="text-gray-400">/</span>
                    {{ row.group?.weekly_limit_usd?.toFixed(2) }} {{ t('common.creditUnit') }}
                  </span>
                </div>
              ...
              <div v-if="row.group?.monthly_limit_usd" class="usage-row">
                <div class="flex items-center gap-2">
                  ...
                  <span class="usage-amount">
                    {{ row.monthly_usage_usd?.toFixed(2) || '0.00' }} {{ t('common.creditUnit') }}
                    <span class="text-gray-400">/</span>
                    {{ row.group?.monthly_limit_usd?.toFixed(2) }} {{ t('common.creditUnit') }}
                  </span>
                </div>
