            ...
            <table class="w-full min-w-[560px] text-left text-sm">
              ...
              <tbody>
                ...
                >
                  ...
                  <td class="px-3 py-3 text-right font-medium text-emerald-600 dark:text-emerald-400">{{ formatAccountMoney(item.total_rebate) }}</td>
...
const formatAccountMoney = (value: number | null | undefined): string =>
  formatPaymentAmount(Number(value || 0), DEFAULT_PAYMENT_CURRENCY)
...
async function transferQuota(): Promise<void> {
  ...
  try {
    ...
    appStore.showSuccess(t('affiliate.transfer.success', { amount: formatAccountMoney(resp.transferred_quota) }))
    await Promise.all([
