            ...
            <div class="text-sm">
              <div class="flex items-center gap-1.5">
                ...
                <span class="font-medium text-gray-900 dark:text-white">
                  {{ (usageStats[row.id]?.today_actual_cost ?? 0).toFixed(4) }} {{ t('common.creditUnit') }}
                </span>
              </div>
              <div class="mt-0.5 flex items-center gap-1.5">
                <span class="text-gray-500 dark:text-gray-400">{{ t('keys.total') }}:</span>
                <span class="font-medium text-gray-900 dark:text-white">
                  {{ (usageStats[row.id]?.total_actual_cost ?? 0).toFixed(4) }} {{ t('common.creditUnit') }}
                </span>
              </div>
              ...
              <div v-if="row.quota > 0" class="mt-1.5">
                <div class="flex items-center gap-1.5">
                  ...
                  <span :class="[
                    ...
                    {{ row.quota_used?.toFixed(2) || '0.00' }} {{ t('common.creditUnit') }} / {{ row.quota?.toFixed(2) }} {{ t('common.creditUnit') }}
                  </span>
                </div>
              ...
              <div v-if="row.rate_limit_5h > 0">
                <div class="flex items-center justify-between text-xs">
                  ...
                  <span :class="[
                    ...
                    {{ row.usage_5h?.toFixed(2) || '0.00' }} {{ t('common.creditUnit') }}/{{ row.rate_limit_5h?.toFixed(2) }} {{ t('common.creditUnit') }}
                  </span>
                </div>
              ...
              <div v-if="row.rate_limit_1d > 0">
                <div class="flex items-center justify-between text-xs">
                  ...
                  <span :class="[
                    ...
                    {{ row.usage_1d?.toFixed(2) || '0.00' }} {{ t('common.creditUnit') }}/{{ row.rate_limit_1d?.toFixed(2) }} {{ t('common.creditUnit') }}
                  </span>
                </div>
                <div class="h-1 w-full overflow-hidden rounded-full bg-gray-200 dark:bg-dark-600">
                  <div
              ...
              <div v-if="row.rate_limit_7d > 0">
                <div class="flex items-center justify-between text-xs">
                  ...
                  <span :class="[
                    ...
                    {{ row.usage_7d?.toFixed(2) || '0.00' }} {{ t('common.creditUnit') }}/{{ row.rate_limit_7d?.toFixed(2) }} {{ t('common.creditUnit') }}
                  </span>
                </div>
                <div class="h-1 w-full overflow-hidden rounded-full bg-gray-200 dark:bg-dark-600">
                  <div
            ...
            <div v-if="showEditModal && selectedKey && selectedKey.quota > 0">
              ...
              <div class="flex items-center gap-2">
                <div class="flex-1 rounded-lg bg-gray-100 px-3 py-2 dark:bg-dark-700">
                  <span class="font-medium text-gray-900 dark:text-white">
                    {{ selectedKey.quota_used?.toFixed(4) || '0.0000' }} {{ t('common.creditUnit') }}
                  </span>
                  <span class="mx-2 text-gray-400">/</span>
                  <span class="text-gray-500 dark:text-gray-400">
                    {{ selectedKey.quota?.toFixed(2) || '0.00' }} {{ t('common.creditUnit') }}
                  </span>
                </div>
                <button
                  type="button"
                ...
                <div class="flex items-center gap-2">
                  <div class="flex-1 rounded-lg bg-gray-100 px-3 py-2 dark:bg-dark-700 text-sm">
                    <span :class="[
                      ...
                      {{ selectedKey.usage_5h?.toFixed(4) || '0.0000' }} {{ t('common.creditUnit') }}
                    </span>
                    <span class="mx-2 text-gray-400">/</span>
                    <span class="text-gray-500 dark:text-gray-400">
                      {{ selectedKey.rate_limit_5h?.toFixed(2) || '0.00' }} {{ t('common.creditUnit') }}
                    </span>
                  </div>
                </div>
                <div class="mt-1 h-1.5 w-full overflow-hidden rounded-full bg-gray-200 dark:bg-dark-600">
                ...
                <div class="flex items-center gap-2">
                  <div class="flex-1 rounded-lg bg-gray-100 px-3 py-2 dark:bg-dark-700 text-sm">
                    <span :class="[
                      ...
                      {{ selectedKey.usage_1d?.toFixed(4) || '0.0000' }} {{ t('common.creditUnit') }}
                    </span>
                    <span class="mx-2 text-gray-400">/</span>
                    <span class="text-gray-500 dark:text-gray-400">
                      {{ selectedKey.rate_limit_1d?.toFixed(2) || '0.00' }} {{ t('common.creditUnit') }}
                    </span>
                  </div>
                </div>
                <div class="mt-1 h-1.5 w-full overflow-hidden rounded-full bg-gray-200 dark:bg-dark-600">
                ...
                <div class="flex items-center gap-2">
                  <div class="flex-1 rounded-lg bg-gray-100 px-3 py-2 dark:bg-dark-700 text-sm">
                    <span :class="[
                      ...
                      {{ selectedKey.usage_7d?.toFixed(4) || '0.0000' }} {{ t('common.creditUnit') }}
                    </span>
                    <span class="mx-2 text-gray-400">/</span>
                    <span class="text-gray-500 dark:text-gray-400">
                      {{ selectedKey.rate_limit_7d?.toFixed(2) || '0.00' }} {{ t('common.creditUnit') }}
                    </span>
                  </div>
                </div>
                <div class="mt-1 h-1.5 w-full overflow-hidden rounded-full bg-gray-200 dark:bg-dark-600">
